...
namespace EcoPlatesMobile.Services.Api
{
    public class ChatApiService : ApiService
    {
        ...
        private const string GET_SENDER_ID_AND_RECEIVER_ID_LIST_WITH_UNREAD_INFO_FOR_USER = $"{BASE_URL}chat/getSendersAndReceiversWithUnreadForUser";
        ...
        public async Task<ChatSenderIdResponse> GetSendersAndReceiversWithUnreadForUser(UnreadMessagesRequest data)
        {
            var response = new ChatSenderIdResponse();

            try
            {
                var receivedData = await PostAsync(GET_SENDER_ID_AND_RECEIVER_ID_LIST_WITH_UNREAD_INFO_FOR_USER, data);
